          ...
          <form onSubmit={sendMessage} className="p-4 bg-white border-t-2 border-[#FFE5E5]">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 border-2 border-[#FFE5E5] rounded-full focus:outline-none focus:border-[#C8102E] transition-colors text-gray-900 placeholder:text-gray-500"
                disabled={isLoading}
              />
              <button
                type="submit"
